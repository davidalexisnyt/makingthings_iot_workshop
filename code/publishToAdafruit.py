...
WIFI_SSID = '<network name>'          # Change to your network name
WIFI_PASSWORD = '<network password>'  # Change to your network password
...
ADAFRUIT_USERNAME = b'<put your adafruit account here'
ADAFRUIT_IO_KEY = b'<adafruit API key'
